...
def main():
  ...
  if args.x and args.x[0] == 'rocm':
    ...
    gpu_linker_flags.append('-I/opt/rh/devtoolset-7/root/usr/include/c++/7')
    gpu_linker_flags.append('/opt/rh/devtoolset-7/root/usr/lib/gcc/x86_64-redhat-linux/7/libstdc++.a')
